...
dict(slug="a-propos", title="Qui sommes-nous : la méthode de Comparépargne",
 ...
 h1="Qui sommes-nous", lead="Comparépargne compare les contrats d'assurance vie, les PER et les placements d'épargne longue. Nous ne vendons aucun contrat, nous n'encaissons aucune commission d'apport et nous ne faisons relire nos comparatifs par aucun assureur.",
 blocks=[
  ...
  ("h2","Comment nous sommes financés"),
  ("p","Par la publicité affichée sur le site et par nos contenus sponsorisés, signalés comme tels quand il y en a. Aucun assureur ne finance un comparatif, ne le relit avant publication ni n'obtient de modification après publication. Nous ne percevons aucune commission sur les contrats souscrits."),
