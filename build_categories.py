...
dict(slug="assurance-vie", nom="Assurance vie", count="14 comparatifs",
 ...
 rank=[("ggvie","Groupama Modulation","Le meilleur contrat du panel","Frais affichés au centime, souscription en ligne en quinze minutes, versement programmé dès 50 € par mois.","9,1","up","▲ +0,3"),
       ("ggvie","Gan Patrimoine","Le plus complet sur les supports","Gamme labellisée ISR de bout en bout, fonds en euros régulier, accompagnement à la demande.","8,7","up","▲ +0,2"),
 ...
 faq=[("Quelle est la meilleure assurance vie en 2026 ?","Il n'y a pas un contrat meilleur pour tout le monde. Sur nos relevés de septembre 2026, Groupama Modulation obtient la meilleure note globale du panel (9,1/10) : des frais affichés au centime, une souscription en ligne en quinze minutes, un versement programmé possible dès 50 € par mois et un fonds en euros au-dessus de la moyenne du marché. Gan Patrimoine suit à 8,7/10 avec la gamme labellisée ISR la plus complète."),
