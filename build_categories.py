...
dict(slug="assurance-vie", nom="Assurance vie", count="14 comparatifs",
 ...
 hero="cat-assurance-vie-hero.svg", hero_alt="",
 ...
 feat=dict(img="une.svg", tag="Classement", h2="Meilleure assurance vie 2026 : le comparatif de 16 contrats",
 ...
 side=[("av-2.svg","Débuter","Où ouvrir une assurance vie quand on débute : banque, assureur ou courtier","9 min de lecture"),
       ("av-3.svg","Épargne","Assurance vie ou Livret A : où placer son épargne en 2026","8 min de lecture"),
       ("rend-2.svg","Frais","Frais d'assurance vie : le comparatif ligne par ligne des 16 contrats","8 min de lecture"),
       ("av-5.svg","Retrait","Rachat partiel : ce qu'il coûte vraiment avant et après huit ans","7 min de lecture")],
 grid_h2="Tous les comparatifs assurance vie",
 grid=[("av-2.svg","Débuter","Où ouvrir une assurance vie quand on débute : banque, assureur ou courtier","Trois circuits de souscription comparés sur le premier versement, le délai d'ouverture, les frais d'entrée et la présence d'un conseiller.","3 circuits","9 min"),
       ("av-3.svg","Épargne","Assurance vie ou Livret A : où placer son épargne en 2026","Disponibilité, plafond, rendement et fiscalité, les deux placements mis côte à côte sur un même versement de 20 000 €.","2 placements","8 min"),
       ("av-4.svg","Sans frais d'entrée","Assurance vie sans frais d'entrée : les contrats à 0 % sur le versement","Les contrats qui ne prélèvent rien à l'entrée et ce qu'ils facturent ailleurs, parce que la gratuité se rattrape toujours quelque part.","11 contrats","7 min"),
       ("av-5.svg","Retrait","Rachat partiel : ce qu'il coûte vraiment avant et après huit ans","Le calcul de la part de gains imposée, les délais de versement relevés contrat par contrat et les pièges de la sortie totale.","16 contrats","7 min"),
       ("av-6.svg","Enfant","Ouvrir une assurance vie au nom de son enfant : ce que la loi permet","Souscription par les parents, accord des deux tuteurs, blocage jusqu'à la majorité et intérêt réel face au livret jeune.","6 contrats","8 min"),
       ("av-1.svg","Montant","Comment placer 100 000 euros en assurance vie sans tout mettre au même endroit","Répartition entre fonds en euros et unités de compte, étalement des versements et limite des 150 000 € de primes.","4 scénarios","10 min")],
 ...
 rank=[("linxea","Linxea Spirit 2","Le meilleur contrat en ligne","Zéro frais de versement, plus de 1 000 supports, gestion libre exigeante.","8,6","up","▲ +0,2"),
       ("boursobank","BoursoVie","Le plus simple à ouvrir","Souscription en dix minutes, frais bas, gamme de supports plus courte.","8,2","flat","= 0,0"),
       ("groupama","Groupama Modulation","Le meilleur contrat accompagné","Fonds en euros solide, conseiller en agence, premier versement accessible.","8,0","up","▲ +0,3"),
       ("macsf","MACSF RES","Le meilleur fonds en euros","Rendement servi le plus élevé du panel, gamme d'unités de compte limitée.","7,8","up","▲ +0,1"),
       ("gan","Gan Patrimoine","Le plus complet sur la transmission","Clauses bénéficiaires sur mesure, accompagnement notarial, frais d'entrée négociables.","7,7","flat","= 0,0")],
 cta_h2="Groupama ou Linxea pour votre épargne ?", cta_p="Comparez deux contrats sur nos cinq critères en un clic.",
 faq_h2="Questions fréquentes sur l'assurance vie",
 faq=[("Quelle est la meilleure assurance vie en 2026 ?","Il n'y a pas un contrat meilleur pour tout le monde. Sur nos relevés de septembre 2026, Linxea Spirit 2 obtient la meilleure note globale (8,6/10) pour un épargnant autonome, grâce à l'absence de frais de versement et à la largeur de sa gamme. Groupama Modulation arrive en tête des contrats accompagnés (8,0/10) pour qui veut un conseiller en face de soi."),
...
dict(slug="rendement-frais", nom="Rendement et frais", count="11 comparatifs",
 ...
 hero="cat-rendement-frais-hero.svg", hero_alt="",
 ...
 feat=dict(img="rend-1.svg", tag="Fonds en euros", h2="Meilleur fonds en euros 2026 : les rendements servis, contrat par contrat",
 ...
 side=[("rend-2.svg","Frais","Frais d'assurance vie : le comparatif ligne par ligne des 16 contrats","8 min de lecture"),
       ("rend-3.svg","Gestion pilotée","Gestion pilotée : quelle assurance vie choisir quand on ne veut pas gérer","9 min de lecture"),
       ("rend-4.svg","Supports","Unités de compte : comment les choisir sans se laisser vendre un catalogue","8 min de lecture"),
       ("rend-5.svg","Simulateur","Ce que rapporte vraiment une assurance vie sur huit ans, calcul à l'appui","6 min de lecture")],
 grid_h2="Tous les comparatifs rendement et frais",
 grid=[("rend-2.svg","Frais","Frais d'assurance vie : le comparatif ligne par ligne des 16 contrats","Versement, gestion sur le fonds en euros, gestion sur les unités de compte, arbitrage et sortie en rente : les cinq lignes, contrat par contrat.","16 contrats","8 min"),
       ("rend-3.svg","Gestion pilotée","Gestion pilotée : quelle assurance vie choisir quand on ne veut pas gérer","Le coût du mandat s'ajoute aux frais du contrat et aux frais des supports. Nous additionnons les trois étages pour chaque offre.","10 offres","9 min"),
       ("rend-4.svg","Supports","Unités de compte : comment les choisir sans se laisser vendre un catalogue","Mille supports ne valent pas mieux que cent si les frais courants ne sont pas affichés. Ce qu'il faut regarder sur une fiche de fonds.","16 contrats","8 min"),
       ("rend-5.svg","Simulateur","Ce que rapporte vraiment une assurance vie sur huit ans, calcul à l'appui","Le même versement de 20 000 € passé dans quatre grilles de frais différentes. L'écart final atteint plusieurs milliers d'euros.","4 scénarios","6 min"),
       ("rend-6.svg","Fonds en euros","Fonds en euros à capital garanti : lesquels garantissent encore 100 % du capital","La garantie nette de frais de gestion n'est pas la garantie brute. Le détail, contrat par contrat.","16 contrats","7 min"),
       ("rend-1.svg","Rendement","Quel rendement espérer d'une assurance vie aujourd'hui, selon la part d'unités de compte","Trois profils d'allocation, trois trajectoires, et ce que la volatilité change sur huit ans.","3 profils","9 min")],
 ...
 rank=[("macsf","MACSF RES","Le rendement le plus élevé","Servi au-dessus de la moyenne du marché sur les trois derniers exercices, sans condition d'unités de compte.","8,6","up","▲ +0,2"),
       ("groupama","Groupama Modulation","Le plus régulier","Trois exercices sans décrochage, garantie du capital nette de frais de gestion.","8,2","up","▲ +0,1"),
       ("gan","Gan Patrimoine","Le meilleur sur les gros encours","Bonus de rendement à partir d'un certain encours, conditions écrites noir sur blanc.","8,0","flat","= 0,0"),
       ...
       ("spirica","Spirica Nouvelle Génération","Le plus dynamique","Rendement au-dessus de la moyenne, mais garantie du capital limitée à 98 %.","7,4","down","▼ -0,2")],
...
dict(slug="fiscalite-succession", nom="Fiscalité et succession", count="8 comparatifs",
 ...
 hero="cat-fiscalite-succession-hero.svg", hero_alt="",
 ...
 feat=dict(img="fisc-1.svg", tag="Fiscalité", h2="Fiscalité de l'assurance vie en 2026 : ce que vous payez vraiment à chaque retrait",
 ...
 side=[("fisc-2.svg","Succession","Clause bénéficiaire : comment la rédiger pour que l'argent arrive où vous voulez","8 min de lecture"),
       ("fisc-3.svg","Transmission","Abattement de 152 500 € par bénéficiaire : comment il se calcule vraiment","7 min de lecture"),
       ("fisc-4.svg","Après 70 ans","Alimenter son contrat après 70 ans : ce que ça change et quand ça reste utile","7 min de lecture"),
       ("fisc-5.svg","Retrait","Rachat partiel avant huit ans : le calcul de la part de gains imposée","6 min de lecture")],
 grid_h2="Tous les dossiers fiscalité et succession",
 grid=[("fisc-2.svg","Succession","Clause bénéficiaire : comment la rédiger pour que l'argent arrive où vous voulez","Clause type, clause démembrée, enfant mineur, concubin, association : cinq rédactions et ce que chacune produit au dénouement.","5 rédactions","8 min"),
       ("fisc-3.svg","Transmission","Abattement de 152 500 € par bénéficiaire : comment il se calcule vraiment","L'abattement s'apprécie par bénéficiaire et tous contrats confondus, ce qui change tout quand on détient plusieurs contrats.","3 cas chiffrés","7 min"),
       ("fisc-4.svg","Après 70 ans","Alimenter son contrat après 70 ans : ce que ça change et quand ça reste utile","Les primes versées après 70 ans relèvent d'un régime distinct, avec un abattement global et des gains traités à part.","2 régimes","7 min"),
       ("fisc-5.svg","Retrait","Rachat partiel avant huit ans : le calcul de la part de gains imposée","Un rachat n'est jamais imposé en totalité. La formule, appliquée pas à pas sur un contrat de 50 000 €.","1 formule","6 min"),
       ("fisc-6.svg","Arbitrage","Assurance vie ou donation : que choisir pour transmettre à ses enfants","Les deux outils ne servent pas au même moment et se cumulent mieux qu'ils ne se remplacent.","2 outils","9 min"),
       ("fisc-1.svg","Déclaration","Déclarer son assurance vie aux impôts : les cases à remplir, année par année","Ce que l'assureur déclare à votre place, ce qui reste à votre charge et l'erreur la plus fréquente sur les contrats à l'étranger.","1 guide","6 min")],
 ...
 rank=[("gan","Gan Patrimoine","Le plus complet sur la clause","Clause sur mesure déposée chez le notaire, démembrement géré, accompagnement à la rédaction.","8,4","up","▲ +0,2"),
       ("groupama","Groupama Modulation","Le plus accompagné","Rendez-vous en agence pour la rédaction, relecture de la clause à chaque étape de vie.","8,1","up","▲ +0,1"),
       ...
       ("linxea","Linxea Spirit 2","Le moins accompagné","Clause libre saisissable en ligne, mais aucune relecture juridique proposée.","6,8","down","▼ -0,1")],
...
dict(slug="per-retraite", nom="PER et retraite", count="9 comparatifs",
 ...
 hero="cat-per-retraite-hero.svg", hero_alt="",
 ...
 feat=dict(img="per-1.svg", tag="Classement", h2="Meilleur PER 2026 : le comparatif de 12 plans d'épargne retraite",
 ...
 side=[("per-3.svg","Arbitrage","PER ou assurance vie : lequel choisir pour préparer sa retraite","9 min de lecture"),
       ("per-4.svg","Fiscalité","Quel avantage fiscal donne un PER selon votre tranche d'imposition","7 min de lecture"),
       ("per-5.svg","Sortie","Sortie en capital ou en rente : ce que chaque option coûte à l'arrivée","8 min de lecture"),
       ("per-6.svg","Méthode","Combien épargner chaque mois pour compléter sa retraite, par âge de départ","8 min de lecture")],
 grid_h2="Tous les comparatifs PER et retraite",
 grid=[("per-3.svg","Arbitrage","PER ou assurance vie : lequel choisir pour préparer sa retraite","Le PER déduit à l'entrée et impose à la sortie, l'assurance vie fait l'inverse. Le bon choix dépend de l'écart entre vos deux tranches.","2 enveloppes","9 min"),
       ("per-4.svg","Fiscalité","Quel avantage fiscal donne un PER selon votre tranche d'imposition","Le même versement de 5 000 € ne rapporte pas la même économie d'impôt à 11 %, à 30 % ou à 41 %. Le tableau complet.","4 tranches","7 min"),
       ("per-5.svg","Sortie","Sortie en capital ou en rente : ce que chaque option coûte à l'arrivée","La part déduite à l'entrée est imposée à la sortie. Nous déroulons les deux options sur un capital de 120 000 €.","2 options","8 min"),
       ("per-6.svg","Méthode","Combien épargner chaque mois pour compléter sa retraite, par âge de départ","Départ à 35, 45 ou 55 ans pour un même objectif de complément mensuel. L'effort double à chaque décennie perdue.","3 scénarios","8 min"),
       ("per-2.svg","Déblocage","Déblocage anticipé du PER : les six cas prévus par la loi","Achat de la résidence principale, invalidité, décès du conjoint, fin de droits, surendettement, cessation d'activité non salariée.","6 cas","6 min"),
       ("per-1.svg","Jeune actif","Préparer sa retraite à 35 ans : par quoi commencer avant d'ouvrir un PER","Épargne de précaution, taux d'endettement, plafond de déduction disponible : trois vérifications avant le premier versement.","1 méthode","7 min")],
 ...
 rank=[("linxea","Linxea PER","Le moins coûteux","Zéro frais de versement, mandat de gestion parmi les moins chers du panel.","8,5","up","▲ +0,2"),
       ("groupama","Groupama PER","Le mieux accompagné","Grille de désensibilisation lisible, point annuel avec un conseiller.","8,0","up","▲ +0,3"),
       ("yomoni","Yomoni Retraite","La meilleure gestion pilotée","Allocation pilotée par horizon claire, reporting détaillé.","7,9","flat","= 0,0"),
       ("macsf","MACSF PER","Le meilleur fonds en euros","Support garanti au rendement le plus élevé du panel PER.","7,7","up","▲ +0,1"),
       ("bnp","PER bancaire moyen","Le plus cher","Frais de versement encore pratiqués, gamme de supports courte.","5,8","down","▼ -0,1")],
 ...
 faq=[("Quel est le meilleur PER en 2026 ?","Sur nos relevés, Linxea PER obtient la meilleure note globale (8,5/10) grâce à l'absence de frais de versement et à un mandat de gestion peu coûteux. Groupama PER arrive en tête des PER accompagnés (8,0/10) pour qui veut un suivi annuel avec un conseiller."),
...
dict(slug="epargne-responsable", nom="Épargne responsable", count="6 comparatifs",
 ...
 hero="cat-epargne-responsable-hero.svg", hero_alt="",
 ...
 feat=dict(img="isr-1.svg", tag="Classement", h2="Meilleure assurance vie ISR 2026 : les contrats qui tiennent leur promesse",
 ...
 side=[("isr-2.svg","Labels","Label ISR, Greenfin, Finansol : ce que chacun garantit vraiment","7 min de lecture"),
       ("isr-3.svg","PER","Quel PER responsable ou labellisé souscrire en 2026","8 min de lecture"),
       ("isr-4.svg","Climat","Placements sans énergies fossiles : quels supports tiennent l'exclusion","8 min de lecture"),
       ("isr-5.svg","Jeune actif","Placer son épargne quand on est jeune actif et qu'on veut du sens","7 min de lecture")],
 grid_h2="Tous les comparatifs épargne responsable",
 grid=[("isr-2.svg","Labels","Label ISR, Greenfin, Finansol : ce que chacun garantit vraiment","Trois labels, trois cahiers des charges, trois niveaux d'exigence. Ce qu'ils vérifient et ce qu'ils ne vérifient pas.","3 labels","7 min"),
       ("isr-3.svg","PER","Quel PER responsable ou labellisé souscrire en 2026","Les PER dont la gestion pilotée par horizon repose sur des supports labellisés, du premier versement à la désensibilisation.","7 PER","8 min"),
       ("isr-4.svg","Climat","Placements sans énergies fossiles : quels supports tiennent l'exclusion","Un fonds peut être labellisé et détenir des producteurs d'énergie fossile. Le détail des exclusions, fonds par fonds.","12 fonds","8 min"),
       ("isr-5.svg","Jeune actif","Placer son épargne quand on est jeune actif et qu'on veut du sens","Ordre des priorités, montant de départ réaliste et supports accessibles sous 100 € par mois.","1 méthode","7 min"),
       ("isr-6.svg","Solidaire","Épargne solidaire : ce que finance vraiment un fonds Finansol","Logement très social, insertion, agriculture durable : à quoi sert la poche solidaire d'un fonds 90/10.","1 dossier","6 min"),
       ("isr-1.svg","Frais","Les fonds durables coûtent-ils plus cher que les autres ?","Comparaison des frais courants entre supports labellisés et supports classiques de même catégorie.","24 fonds","7 min")],
 ...
 rank=[("maif","MAIF Responsable","Le plus engagé de bout en bout","Gamme intégralement labellisée, exclusions écrites, reporting annuel détaillé.","8,7","up","▲ +0,2"),
       ("groupama","Groupama Modulation ISR","Le plus accessible","Gamme labellisée disponible dès le premier versement, sans surcoût de frais.","8,0","up","▲ +0,3"),
       ("linxea","Linxea Spirit 2","Le plus large","Grand nombre de supports labellisés, mais mélangés au reste du catalogue.","7,6","flat","= 0,0"),
       ("yomoni","Yomoni Responsable","La meilleure gestion pilotée verte","Mandat entièrement construit sur des supports labellisés.","7,4","flat","= 0,0"),
...
def render(c):
    ...
    rank = "".join(f'''
      <div class="rank-row"><span class="pos{" first" if i==0 else ""}">0{i+1}</span><img src="{R}assets/logos/{logo}.svg" alt="{alt}" width="120" height="33" loading="lazy"><div class="why"><b>{b}</b>{why}</div><div class="score"><b>{sc}</b><small>/10</small><span class="chip{"" if cls=="up" else " "+cls}">{chip}</span></div></div>''' for i, (logo, alt, b, why, sc, cls, chip) in enumerate(c["rank"]))
    faq = "".join(f'''
